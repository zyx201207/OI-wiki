...
由于GreasyFork在中国大陆被封锁，可以去 [greasyfork镜像站](https://greasyfork.icu/zh-CN/scripts/369954-ac-predictor) 安装.

安装完成后，比赛的排行榜界面会显示每个用户的 rating 变化预测，还有 Estimator，可以预测达到目标 rating 所需要的Perf和达到预期Perf时将获得的 rating．

这个工具有一个经由 [GoodCoder666](https://github.com/GoodCoder666) 汉化的版本，点击 [这里](https://greasyfork.icu/zh-CN/scripts/458528-ac-predictor-cn) 以安装，不过这个版本基于较老的ac-predictor汉化，所以预测精度较最新的ac-predictor稍低，还会偶尔出几个错误，建议使用经由 [zyx201207](https://github.com/zyx201207) 汉化的版本，点击 [这里](https://github.com/zyx201207/ac-predictor-zh) 跳转到 GitHub，选择最新版本下载到本地，并点击`篡改猴>添加新脚本`粘贴进去．
