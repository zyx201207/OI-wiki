...
完成后~~来到 [greasyfork](https://greasyfork.org/zh-CN/scripts/369954-ac-predictor)，点击安装即可~~由于GreasyFork主站在中国大陆被封锁，可以来 [greasyfork镜像站](https://greasyfork.icu/zh-CN/scripts/369954-ac-predictor)．

安装完成后，比赛的排行榜界面会显示每个用户的 rating 变化预测．

这个工具有一个经由 [GoodCoder666](https://github.com/GoodCoder666) 汉化的版本，点击 [这里](https://greasyfork.icu/zh-CN/scripts/458528-ac-predictor-cn) 以安装，不过这个算得不是很准，有时候还会出点小错误．

还有一个由笔者亲手汉化的版本，点击 [ac-predictor-zh](https://github.com/zyx201207/ac-predictor-zh)，选择最新版本下载到本地，并点击篡改猴>添加新脚本，粘进去，保存即可.
